...
const InfoPage = () => {
    ...
    return(
        ...
        <div className="container-fluid pb-5 bg-light">
            ...
            <img src="http://www.socal-wellness.com/wp-content/uploads/2017/04/Suhar-evil-why-so-bad.jpg" className="rounded mx-auto d-block" alt="sugar devil" />
